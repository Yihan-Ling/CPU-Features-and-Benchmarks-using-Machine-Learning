...
new_columns = ["pos", "model", "cache", "tdp", "frequency", "cores", "process", "pref", "y1", "y2"]
...
named_data["cache_l1"] = named_data["cache"].apply(lambda x: convert_cache_label(x, 1))
...
x = np.array(data["cache_l1"].values)
